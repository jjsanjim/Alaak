...
function SettingIcon({ ...props }: SvgProps) {
  if (!props.width) props.width = 26;
  if (!props.height) props.height = 26;
  if( !props.color) props.color = "#333333"
  return (
    <Svg viewBox="0 0 24 24" fill="none" {...props}>
      <G stroke={props.color} strokeWidth={1.5} strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round">
